...
```
<br><br><br>
I made a graph based on the most useful features for random forest, which where instrumentalness, aurasal and danceability. In the interative plot we can see that there are areas where AI or non AI music tend to be. However we can still see much overlap in some areas. Also the danceability in some areas is higher for AI music.
